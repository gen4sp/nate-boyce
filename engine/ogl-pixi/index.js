...
// import  advectionManualFilteringShader from './shaders/amf.frag'
...
function init(renderer) {
  ...
  //     gl,
  //     { width, height, wrapS, wrapT, minFilter = gl.LINEAR, magFilter = minFilter, type, format, internalFormat, depth } = {}
  // ) {
